    ...
    <table class="dashboard-table">
        <tr>
            <td class = "dashboard-td">
                <a href="assigned.php" style="text-decoration: none;">
                    <div class="dashboard-box">My Assigned Students</div>
                </a>
            </td>

            <td class = "dashboard-td">
                <a href="marks.php" style="text-decoration: none;">
                    <div class="dashboard-box">Enter Assessment Marks</div>
                </a>
            </td>

            <td class = "dashboard-td" rowspan="2">
